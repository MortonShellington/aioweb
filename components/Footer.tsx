    ...
    <footer className="border-t border-white/5 bg-aion-nav/80 py-16 px-6 relative mt-auto">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 items-start relative z-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Link href="#" className="text-sm text-aion-muted hover:text-white transition-colors">Terms of Service</Link>
          <Link href="#" className="text-sm text-aion-muted hover:text-white transition-colors">Privacy Policy</Link>
